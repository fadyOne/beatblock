import { Field, isReady, MerkleMap, Poseidon, PrivateKey, shutdown, Signature, } from "snarkyjs";
import { MerkleMapExtended, Proposal, StateTransition, Vote, VoterData, } from "./vote_aggregator/sequencer.js";
import { Prover } from "./vote_aggregator/prover.js";
import { calculateNullifierRootTransition, calculateVotes, } from "./vote_aggregator/lib.js";
await isReady;
...
console.log("added three dummy voters, root: ", VoterDataTree.getRoot().toString());
...
let { rootBefore, rootAfter } = calculateNullifierRootTransition(NullifierTreeTemp, votes);
