import {
  ...
  export function getContractClass(voteAggregator: any) {
    const RecursiveVoteProof_ = ZkProgram.Proof(voteAggregator);
    ...
    class SettlementContract extends SmartContract {
      ...
      @method setElectionDetails(
        ...
        this.voterDataRoot.set(voterDataRoot);
